...
signupForm.addEventListener('submit', async (e) => {
  ...
  try {
    // Check username uniqueness in 'officials' collection
    ...
    console.log("Trying to set document for UID:", user.uid);
    console.log("Current user:", auth.currentUser?.uid);
console.log("Expected UID for document:", user.uid);


    const user = auth.currentUser;
    if (!user) throw new Error("User authentication failed.");

    // Save user profile in Firestore under 'officials' collection
